...
export declare type HandleChange = ({ type, target, }: MouseEvent) => Promise<void | boolean>;
...
export declare type Control<FormValues extends FieldValues = FieldValues> = {
    ...
    register<Element extends ElementLike = ElementLike>(name: FieldName<FormValues>, validationOptions?: ValidationOptions): void;
    register<Element extends ElementLike = ElementLike>(namesWithValidationOptions: Record<FieldName<FormValues>, ValidationOptions>): void;
...
export declare type AsProps<As extends undefined | React.ReactElement | keyof JSX.IntrinsicElements = undefined> = As extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[As] : As extends React.ReactElement ? {
    [key: string]: any;
} : As extends undefined ? {} : never;
...
export declare type UseFieldArrayProps<ControlProp extends Control = Control> = {
    control?: ControlProp;
    name: string;
};
export declare type WithFieldId<Value> = {
    id?: string;
} & Value;
export {};
