...
var isFileListObject = (data) => data instanceof FileList;
...
const Controller = (_a) => {
    ...
    return React.isValidElement(InnerComponent) ? (React.cloneElement(InnerComponent, props)) : (React.createElement(InnerComponent, Object.assign({}, props)));
};
