...
var isFileInput = (function (type) { return type === FILE_INPUT; });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = {};
                    return [4 /*yield*/, validationSchema.validate(data, { abortEarly: false })];
...
var isFileListObject = (function (data) { return data instanceof FileList; });
...
function useForm(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.mode, mode = _c === void 0 ? VALIDATION_MODE.onSubmit : _c, _d = _b.reValidateMode, reValidateMode = _d === void 0 ? VALIDATION_MODE.onChange : _d, validationSchema = _b.validationSchema, _e = _b.defaultValues, defaultValues = _e === void 0 ? {} : _e, _f = _b.submitFocusError, submitFocusError = _f === void 0 ? true : _f, validateCriteriaMode = _b.validateCriteriaMode;
    ...
    var setDirty = function (name) {
        ...
        var isDirtyChanged = isFieldArray
            ? isDirtyRef.current
    ...
    var executeSchemaValidation = useCallback(function (payload) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, validateWithSchema(validationSchema, validateAllFieldCriteria, getFieldValueByName(fieldsRef.current))];
                case 1:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, validateWithSchema(validationSchema, validateAllFieldCriteria, getFieldValueByName(fields))];
                        case 1:
    ...
    var validateSchemaIsValid = useCallback(function () {
        ...
        validateWithSchema(validationSchema, validateAllFieldCriteria, transformToNestObject(fieldValues)).then(function (_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, validateWithSchema(validationSchema, validateAllFieldCriteria, transformToNestObject(fieldValues))];
                case 2:
...
var appendId = function (value) { return (__assign(__assign({}, (isObject(value) ? value : { value: value })), { id: generateId() })); };
var mapIds = function (data) {
    return (isArray(data) ? data : []).map(function (value) { return appendId(value); });
};

var removeArrayAt = (function (data, index) {
    return !isUndefined(index) && isArray(data)
        ? __spread(data.slice(0, index), data.slice(index + 1)) : [];
});
...
function useFieldArray(_a) {
    ...
    var _b = control || methods.control, resetFieldArrayFunctionRef = _b.resetFieldArrayFunctionRef, fieldArrayNamesRef = _b.fieldArrayNamesRef, fieldsRef = _b.fieldsRef, getValues = _b.getValues, defaultValuesRef = _b.defaultValuesRef, removeFieldEventListener = _b.removeFieldEventListener, errorsRef = _b.errorsRef, isDirtyRef = _b.isDirtyRef, touchedFieldsRef = _b.touchedFieldsRef, readFormStateRef = _b.readFormStateRef, watchFieldArrayRef = _b.watchFieldArrayRef;
    var memoizedDefaultValues = useRef$1(get(defaultValuesRef.current, name, []));
    var _c = __read(useState$1(mapIds(memoizedDefaultValues.current)), 2), fields = _c[0], setField = _c[1];
    ...
    var append = function (value) {
        ...
        watchFieldArrayRef.current[name] = __spread(fields, (isArray(value) ? value.map(appendId) : [appendId(value)]));
